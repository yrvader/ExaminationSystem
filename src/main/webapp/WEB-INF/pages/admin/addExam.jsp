...
<div class="container">
    ...
    <form method="post" action="${appContext}/admin/addExam" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="pnumberInput" name="pnumber" placeholder="请输入答卷数量">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="snumberInput" name="snumber" placeholder="请输入题数">
            </div>
        </div>
        <div class="form-group">
            ...
            $.get(
                ...
                function(result){
                    if(result=="该科目考试已存在"){
                        ...
                        $("#subjectTips").parent().addClass("has-error");
                        $("button").addClass("disabled");
                    }else{
                        $("#subjectTips").addClass("success").text(result);
                        $("#subjectTips").parent().addClass("has-success");
